    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 1px 1px, hsl(var(--cyan) / 0.3) 1px, transparent 0)`,
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            web, mobile, and software solutions that drive growth and efficiency.
          </motion.p>
      ...
      >
        ...
        >
          <motion.div className="w-1.5 h-3 rounded-full bg-cyan" />
        </motion.div>
      </motion.div>
    </section>
  );
