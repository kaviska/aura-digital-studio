  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold font-display ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-r from-cyan via-primary to-accent text-primary-foreground hover:opacity-90 hover:shadow-lg hover:shadow-cyan/30",
        hero: "bg-gradient-to-r from-cyan to-accent text-primary-foreground font-bold hover:opacity-90 hover:shadow-xl hover:shadow-cyan/40 hover:-translate-y-0.5",
        "hero-outline": "border-2 border-cyan/50 bg-transparent text-foreground hover:bg-cyan/10 hover:border-cyan hover:shadow-lg hover:shadow-cyan/20",
